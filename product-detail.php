            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="shop-grid.php">Tất Cả Sản Phẩm</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
                ...
                <div class="quickview-content">
                    ...
                    <div class="quickview-ratting-review">
                        ...
                        <div class="quickview-stock">
                            <span><i class="fa fa-check-circle-o"></i>Sản phẩm có sẵn <?php echo $row_product['qty'] ?></span>
                        </div>
                    </div>
                    <h3>$<?php echo $row_product['price'] ?></h3>
                    ...
                    <div class="quantity">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="quant[1]" id="num" class="input-number" data-min="1" data-max="<?php echo $row_product['qty'] ?>" value="1">
                    ...
                    <div class="add-to-cart">
                        <button class="btn" onclick="add_cart(<?php echo $row_product['id'] ?>)">Thêm Vào Giỏ</button>
                    </div>
                </div>
            </div>
        </div>
        <?php if (isset($_SESSION['customers'])) {
            $id_customer = $_SESSION['customers']['id'];
        ?>
            <div class="col-12">
                <div class="reply">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group button">
                                        <input type="hidden" name="id_customers" id="id_customers" value="<?php echo $id_customer ?>">
                                        <button name="submit" onclick="addCmt(<?php echo $row_product['id'] ?>)" type="submit" class="btn">Gửi Bình Luận</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        ?>
            ...
            <div class="col-12">
                <h3 class="comment-title">Bình Luận</h3>
                <br>
                <a style="color:aliceblue;" class="btn" href="login.php">Đăng Nhập Để Bình Luận</a>
            </div>
            <div class="col-12">
                <div class="comments" id="load">
...
<script>
    function addCmt(id) {
        var id_customer = $('#id_customers').val();
