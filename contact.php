				...
				<div class="col-lg-4 col-12">
					<div class="single-head">
						<div class="single-info">
							...
							<ul>
								<li>+84 702-035-116</li>
								<li>+84 829-576-961</li>
							</ul>
						</div>
						<div class="single-info">
							...
							<ul>
								<li><a href="mailto:joyoivs@gmail.com" target="_blank">joyoivs@gmail.com</a></li>
								<li><a href="mailto:soulivone9@gmail.com" target="_blank">soulivone9@gmail.com</a></li>
							</ul>
						</div>
						<div class="single-info">
							...
							<ul>
								<li>459 Tôn Đức Thắng, Q.Liên Chiểu, P.Hòa Khánh Nam, TP.Đà Nẵng</li>
							</ul>
						</div>
					</div>
				</div>
