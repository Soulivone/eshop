			...
			<div class="col-12">
				<div class="bread-inner">
					<ul class="bread-list">
						...
						<li class="active"><a href="">Trang Tin Tức</a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="row">
						...
						<div class="col-12">
							...
							<div class="blog-detail">
								...
								<div class="blog-meta">
									<span class="author"><a href="#"><i class="fa fa-user"></i>Từ Admin</a><a href="#"><i class="fa fa-calendar"></i><?php echo $row_blog['created_at'] ?></a></span>
								</div>
								<div class="content">
										...
										<div class="row">
											...
											<div class="col-12">
												<div class="form-group button">
													<button name="submit" onclick="ajaxCMT(<?php echo $row_blog['id'] ?>)" type="submit" class="btn">Gửi Bình Luận</button>
												</div>
											</div>
										</div>
									</form>
			...
			<div class="col-lg-4 col-12">
				<div class="main-sidebar">
					...
					<div class="single-widget search">
						<div class="form">
							<input type="search" id="search_blog" placeholder="Tìm Kiếm...">
