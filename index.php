...
<section class="hero-slider">
	<!-- Single Slider -->
	<div class="single-slider" style=" background-image: url('https://dienmayhlp.com/cdn/images/TIvi/phan-biet-cac-loai-tivi-tren-thi-truong-smart-tivi-02.jpg');">
		<div class="container">
						...
						<div class="row">
							<div class="col-lg-7 col-12">
								<div class="hero-text">
									...
									<div class="button">
										<a href="shop-grid.php" class="btn">MUA NGAY!</a>
									</div>
								</div>
							</div>
						</div>
