            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="order.html">Thanh Toán</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a style="color:blue" href="javascript:void(0)" onclick="orderDetail(<?php echo $row_order['id_order'] ?>)">Xem Chi tiết</a></td>
                            </tr>
                        <?php }  ?>
                    </tbody>
                    <?php 
