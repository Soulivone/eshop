                        ...
                        <tbody id="load">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="admin/cat/edit.php?id=<?php echo $row_cat['id'] ?>" class="btn btn-success">Cập Nhật</a> <a href="admin/cat/del.php?id=<?php echo $row_cat['id'] ?>" class="btn btn-danger">Xóa</a></td>
                                </tr>
                            <?php
                            }
                            ?>
        ...
        <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link" href="admin/cat?page=<?php echo $next ?>">Tiếp</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
