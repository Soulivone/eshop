                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="admin/userAdmin/edit.php?id=<?php echo $row['id']?>" class="btn btn-success">Cập Nhật</a> <a href="admin/userAdmin/del.php?id=<?php echo $row['id']?>" class="btn btn-danger">Xóa</a></td>
                                </tr>
                            <?php
                            }
                            ?>
        ...
        <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link" href="admin/userAdmin?page=<?php echo $next ?>">Next</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
