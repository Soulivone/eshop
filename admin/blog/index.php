                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-success" href="admin/blog/edit.php?id=<?php echo $row_blog['id']?>">Cập Nhật</a>  <a class="btn btn-danger" href="admin/blog/del.php?id=<?php echo $row_blog['id']?>">Xóa</a></td>
                                </tr>
                            <?php
                            }
                            ?>
        ...
        <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link" href="admin/blog?page=<?php echo $next ?>">Tiếp</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
