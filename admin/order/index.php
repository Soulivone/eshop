                            ...
                            ?>
                                <tr >
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td><a href="admin/order/detail.php?id=<?php echo $row_order['id_order'] ?>">Xem Chi Tiết</a></td>
                                    <?php 
                                    if($_SESSION['userAdmin']['role'] == 0) {
        ...
        <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link" href="admin/order?page=<?php echo $next ?>">Tiếp</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
