...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Xem Chi Tiết Đơn Hàng</h1>
                </div><!-- /.col -->
                ...
                <div class="col-sm-12">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td style="color:red">Cập Nhật Đơn Hàng</td>
                                <td>
                                    <form action="javascript:void(0)" method="POST">
                                        ...
                                        <button type="submit" onclick="updateOrder(<?php echo $id ?>)" name="submit" class="btn-success">Cập Nhật</button>
                                    </form>
                                </td>
                            </tr>
                            <?php }?>
