                ...
                <div class="col-sm-4">
                    ...
                    ?>
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Lộc" name="submit" class="btn btn-primary">
                            </div>
                        </form>
                    <?php
                    } else {
                    ...
                    ?>
                        <a href="admin/statistical/">Trở lại</a>
                    <?php
                    }
                    ?>
                </div><!-- /.col -->
        ...
        <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        <li class="page-item">
                            <a class="page-link" href="admin/statistical?page=<?php echo $next ?>">Tiép</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
