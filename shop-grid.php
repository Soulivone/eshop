			...
			<div class="col-12">
				<div class="bread-inner">
					<ul class="bread-list">
						...
						<li class="active"><a href="shop-grid.html">Sản Phẩm Hiện Có</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-3 col-md-4 col-12">
				<div class="shop-sidebar">
					...
					<div class="single-widget range">
						<h3 class="title">Tìm Theo Giá</h3>
								...
								<div class="product-img">
									...
									<div class="button-head">
										<div class="product-action-2">
											...
											<a title="Add to cart" href="javascript:void(0)" onclick="add_cart(<?php echo $row_pr['id'] ?>)">Thêm Vào Giỏ Hàng</a>
										</div>
									</div>
								</div>
					...
					<div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
						<nav aria-label="...">
							<ul class="pagination" style="display:flex">
								...
								?>
									<li class="page-item">
										<a class="page-link" href="shop-grid.php?page=<?php echo $next ?>">Tiếp</a>
									</li>
								<?php } ?>
							</ul>
						</nav>
