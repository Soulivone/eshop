...
<head>
	...
	<!-- Web Font -->
	<base href="http://https://soulivone.github.io/eshop/eshop/">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i>+84 702035116</li>
								<li><i class="ti-email"></i> JT@gmail.com</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
					<div class="col-lg-8 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								?>
									<li><i class="ti-user"></i> <a>Tài Khoản</a></li>
					...
					<div class="col-lg-8 col-md-7 col-12">
						<div class="search-bar-top">
							<div class="search-bar">
								<input name="search" id="search" placeholder="Tìm kiếm sản phẩm....." type="search" style=" border: none; outline: none;">
							</div>
						</div>
					</div>
